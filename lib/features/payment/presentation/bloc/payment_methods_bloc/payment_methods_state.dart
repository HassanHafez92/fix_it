...
/// Example usage:
/// ```dart
/// // Example: Create and use PaymentMethodsState
/// final obj = PaymentMethodsState();
...
/// Example usage:
/// ```dart
/// // Example: Create and use PaymentMethodsInitial
/// final obj = PaymentMethodsInitial();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use PaymentMethodsLoading
/// final obj = PaymentMethodsLoading();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use PaymentMethodsLoaded
/// final obj = PaymentMethodsLoaded();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use PaymentMethodsError
/// final obj = PaymentMethodsError();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use PaymentMethodDeleted
/// final obj = PaymentMethodDeleted();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use DefaultPaymentMethodUpdated
/// final obj = DefaultPaymentMethodUpdated();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
