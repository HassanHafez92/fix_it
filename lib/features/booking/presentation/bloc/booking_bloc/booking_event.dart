...
/// Example usage:
/// ```dart
/// // Example: Create and use BookingEvent
/// final obj = BookingEvent();
...
/// Example usage:
/// ```dart
/// // Example: Create and use StartBookingEvent
/// final obj = StartBookingEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use SelectServiceEvent
/// final obj = SelectServiceEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use SelectProviderEvent
/// final obj = SelectProviderEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use SelectDateEvent
/// final obj = SelectDateEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use SelectTimeEvent
/// final obj = SelectTimeEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use SelectDateTimeEvent
/// final obj = SelectDateTimeEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use UpdateAddressEvent
/// final obj = UpdateAddressEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use UpdateCityEvent
/// final obj = UpdateCityEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use UpdatePostalCodeEvent
/// final obj = UpdatePostalCodeEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use UpdateNotesEvent
/// final obj = UpdateNotesEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use SelectPaymentMethodEvent
/// final obj = SelectPaymentMethodEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use ConfirmBookingEvent
/// final obj = ConfirmBookingEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use LoadServicesEvent
/// final obj = LoadServicesEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use LoadProvidersEvent
/// final obj = LoadProvidersEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
