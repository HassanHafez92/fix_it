...
/// Example usage:
/// ```dart
/// // Example: Create and use AppSettingsModel
/// final obj = AppSettingsModel();
...
class AppSettingsModel extends AppSettingsEntity {
  ...
  String toJson() {
    final map = toMap();
    return '{"language":"${map['language']}","currency":"${map['currency']}","pushNotificationsEnabled":${map['pushNotificationsEnabled']},"emailNotificationsEnabled":${map['emailNotificationsEnabled']},"locationServicesEnabled":${map['locationServicesEnabled']},"dataSharingEnabled":${map['dataSharingEnabled']},"theme":"${map['theme']}"}';
  }
