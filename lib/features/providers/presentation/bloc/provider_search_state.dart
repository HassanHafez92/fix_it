...
/// Example usage:
/// ```dart
/// // Example: Create and use ProviderSearchState
/// final obj = ProviderSearchState();
...
/// Example usage:
/// ```dart
/// // Example: Create and use ProviderSearchInitial
/// final obj = ProviderSearchInitial();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use ProviderSearchLoading
/// final obj = ProviderSearchLoading();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use ProviderSearchLoaded
/// final obj = ProviderSearchLoaded();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use ProviderSearchError
/// final obj = ProviderSearchError();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
