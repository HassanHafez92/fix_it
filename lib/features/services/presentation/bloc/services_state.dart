...
/// Example usage:
/// ```dart
/// // Example: Create and use CategoriesLoading
/// final obj = CategoriesLoading();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use CategoriesLoaded
/// final obj = CategoriesLoaded();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use CategoriesError
/// final obj = CategoriesError();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
