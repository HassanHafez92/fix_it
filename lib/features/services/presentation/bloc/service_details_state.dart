...
/// Example usage:
/// ```dart
/// // Example: Create and use ServiceDetailsState
/// final obj = ServiceDetailsState();
...
/// Example usage:
/// ```dart
/// // Example: Create and use ServiceDetailsInitial
/// final obj = ServiceDetailsInitial();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use ServiceDetailsLoading
/// final obj = ServiceDetailsLoading();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use ServiceDetailsLoaded
/// final obj = ServiceDetailsLoaded();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use ServiceDetailsError
/// final obj = ServiceDetailsError();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
