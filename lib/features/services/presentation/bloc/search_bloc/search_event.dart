...
/// Example usage:
/// ```dart
/// // Example: Create and use SearchEvent
/// final obj = SearchEvent();
...
/// Example usage:
/// ```dart
/// // Example: Create and use SearchQueryChangedEvent
/// final obj = SearchQueryChangedEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
...
/// Example usage:
/// ```dart
/// // Example: Create and use PerformSearchEvent
/// final obj = PerformSearchEvent();
/// // call methods or wire into a Bloc/Widget
/// ```
///
/// NOTE: Replace the placeholders above with specific details.
